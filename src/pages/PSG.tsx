...
const COLORS = ['#10B981', '#3B82F6', '#F59E0B', '#EF4444', '#8B5CF6', '#EC4899', '#6366F1', '#14B8A6', '#F97316', '#84CC16', '#CBD5E1'];
...
const PSG = () => {
  ...
  const chartData = useMemo(() => {
    ...
    if (data.length > 10 || preExistingOthers > 0) {
      ...
      const othersSum = others.reduce((sum, item) => sum + item.allocation_pct, 0) + preExistingOthers;
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 gap-4">
          <div>
            ...
            <p className="text-gray-600 mt-1">Deep analysis and health check for your investments.</p>
          </div>
        </div>
          ...
          {!analysisResult ? (
            <div className="grid md:grid-cols-2 gap-8">
              ...
              <Card className="border-2 border-learngreen-50 bg-learngreen-50/10 hover:border-learngreen-200 transition-colors">
                <CardHeader>
                  <CardTitle className="flex items-center gap-2"><Briefcase className="w-5 h-5 text-learngreen-600" /> Virtual Portfolio</CardTitle>
                ...
                <CardContent>
                  ...
                  <Button onClick={analyzeVirtualPortfolio} disabled={analyzing} className="w-full bg-learngreen-600 hover:bg-learngreen-700">
